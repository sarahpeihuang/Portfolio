  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[100px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className=' text-yellow-200'>Sarah</span></h1>
          <p className={`${styles.heroSubText} text-black`}>I am a third year Software Engineering and Business Student at Western University</p>
        </div>
      </div>
      <ComputersCanvas/>
